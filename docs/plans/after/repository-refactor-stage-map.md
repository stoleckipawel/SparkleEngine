...
| 17A | Not started | Added after Stage 17 because shader registrations still repeat shader/package/layout/path/entry/stage metadata by hand. | Replace handwritten renderer shader registration boilerplate with a manifest-driven or generated authoring flow while preserving typed parameter/reflection diagnostics. |
