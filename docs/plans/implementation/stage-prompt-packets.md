...
| [10](../rhi-renderer-review-ready-implementation-plan.md#stage-10---validation-milestone-b-rhi-services-capture-interop-upscaling) | Validate RHI services, capture, interop, upscaling. | Comparable D3D12/Vulkan evidence, feature reports, launcher smoke artifacts, and known-difference notes. | Shader/package validation, launcher smoke, D3D12, Vulkan, feature reports, docs. |
...
| [15](../rhi-renderer-review-ready-implementation-plan.md#stage-15---validation-milestone-c-renderer-facade-frame-pipeline-frame-graph) | Validate renderer facade/frame graph. | D3D12/Vulkan smoke-visible graph diagnostics prove unresolved resources/barriers are handled. | None. |
