...
| `Tools/Import/SourceImporters` | External source format import into imported DTOs and import reports. | Source import must not leak into GameFramework or Renderer runtime. | SourceImporters produce source diagnostics and imported DTOs only. |
