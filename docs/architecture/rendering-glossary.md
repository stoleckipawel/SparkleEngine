...
| Render pass definition | Renderer-owned immutable pass intent: name, shader package, pipeline kind, render state, feature requirements, and diagnostics names. | [RenderPassDefinition.h](../../Engine/Renderer/Private/Passes/RenderPassDefinition.h) | Ordinary passes publish this instead of adding central pipeline traits. |
...
| PSO key | Explicit printable identity for a pass runtime/pipeline state. | [PipelineRuntimeKey.h](../../Engine/Renderer/Private/PipelineRuntime/PipelineRuntimeKey.h), [pipeline-runtime-contract.md](pipeline-runtime-contract.md) | Renderer pipeline runtime owns the key; pass entry is definition-driven after Stage 17. |
| PipelineRuntimeLibrary | Owner for package loading, capability validation, binding layout creation, explicit PSO key logging, and normalized RHI PSO creation. | [PipelineRuntimeLibrary.h](../../Engine/Renderer/Private/PipelineRuntime/PipelineRuntimeLibrary.h), [pipeline-runtime-contract.md](pipeline-runtime-contract.md) | Consumes pass definitions through `RenderPassDefinitionRuntime` after Stage 17. |
