...
| Remaining risk | Stage 17B must measure and reduce the whole pass-add workflow; Stage 20 must capture D3D12/Vulkan runtime smoke with PSO key logs. Stage 22 can decide whether the Stage 17B manifest/generator becomes the long-term ShaderContracts shape. |
