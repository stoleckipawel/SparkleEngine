...
| Renderer | Frame graph, low-friction pass authoring, pipeline runtime, scene staging, feature providers. | Central per-pass traits, duplicated shader registration data, backend-native shortcuts, and recurring mechanical pass-add edits. |
