...
| RenderContracts | [repository-target-architecture.md](repository-target-architecture.md), [rendering-system-map.md](../rendering-system-map.md), [game-framework-contract.md](../game-framework-contract.md), [render-scene-data-contract.md](../render-scene-data-contract.md) | 13, 20, 24, 29, 30 | GameFramework produces immutable render snapshots; Renderer consumes snapshots without gameplay/private coupling. |
...
| ValidationWorkflows | [validation-workflow-contract.md](../validation-workflow-contract.md), [tooling-pipeline-contract.md](../tooling-pipeline-contract.md), [rendering-coverage-status.md](../rendering-coverage-status.md) | 10, 15, 20, 21, 27, 29, 30 | User-facing validation runs through Launcher or launcher-shaped direct execution, with operation fields, working directory, environment, logs, artifacts, and diagnostics recorded. |
...
| Renderer system | [rendering-system-map.md](../rendering-system-map.md), [rendering-coverage-status.md](../rendering-coverage-status.md), [render-scene-data-contract.md](../render-scene-data-contract.md) | 4, 10, 11, 12, 13, 20, 22, 30 | Renderer is a host-facing facade over frame pipeline, scene/resource staging, and feature systems. |
...
| GameFramework | [game-framework-contract.md](../game-framework-contract.md), [render-scene-data-contract.md](../render-scene-data-contract.md), [repository-coverage-status.md](../repository-coverage-status.md) | 13, 24, 27, 29, 30 | Runtime/cooked ownership is clear; renderer consumes immutable snapshots/DTOs. |
...
| System | Design docs | Plan stages | Target evidence |
| --- | --- | --- | --- |
| SparkleLauncherCore | [tooling-pipeline-contract.md](../tooling-pipeline-contract.md), [validation-workflow-contract.md](../validation-workflow-contract.md), [repository-system-map.md](../repository-system-map.md) | 10, 15, 20, 26, 28, 29, 30 | Plans and runs build/cook/launch/maintenance processes and records evidence; smoke validation follows launcher operation fields even when automated directly. |
