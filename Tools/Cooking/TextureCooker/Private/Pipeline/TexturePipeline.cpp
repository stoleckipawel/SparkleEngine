...
TextureLoadResult TexturePipeline::Process(const TextureCookRequest& request, TextureLoadResult sourceTexture)
{
	...
	TextureCookPipeline::WorkingTexture workingTexture = TextureCookPipeline::BuildWorkingTexture(request, sourceTexture);
