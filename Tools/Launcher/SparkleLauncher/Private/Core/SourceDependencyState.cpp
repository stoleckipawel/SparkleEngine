		...
		static const std::vector<SourceDependencyGroup> groups = []
		{
			...
			entries.push_back(
			    {"core-workspace",
			        ...
			        "Baseline packages shared by the launcher, engine, and content builds.",
			...
			entries.push_back(
			    {"content-pipeline",
			        ...
			        contentPipelineEnabled ? "Enabled by workspace feature settings."
			                               : "Skipped because the content-pipeline workspace feature is off.",
			        false,
			...
			entries.push_back(
			    {"shader-compiler",
			        ...
			        shaderCompilerEnabled ? "Enabled by workspace feature settings."
			                              : "Skipped because the shader-compiler workspace feature is off.",
			        false,
			...
			entries.push_back(
			    {"nvidia-streamline",
			        ...
			        "Stages Streamline and DLSS runtime files, keeps NVAPI/PTLAS source integration available for local rebuilds, and "
			        "expects the Vulkan SDK on the host for renderer builds.",
