...
namespace SparkleLauncher
{
	...
	void ApplyLauncherVisualStyle(QWidget& rootWidget)
	{
		...
		addRule("#CommandIdentityBar", "background: transparent; border: none; padding: 0 0 10px 0;");
		addRule("#CommandProductTitle", "color: " + textPrimary + "; font-size: 19pt; font-weight: 900; letter-spacing: -0.35px;");
		addRule("#CommandProductSubtitle", "color: " + textSecondary + "; font-size: 9.25pt; font-weight: 600;");
		...
		addRule("#CommandHeroArtworkPane", "background: #050605; border: none; border-left: 1px solid #26301d;");
		addRule("#CommandHeroArtwork", "background: transparent; border: none;");
		addRule("#CommandCarouselDot", "background: #686f65; border: none; border-radius: 2px; min-height: 5px; max-height: 5px;");
		addRule("#CommandCarouselDot[Active=\"true\"]", "background: " + accent + ";");
		addRule("#CommandHeroTitle", "color: #ffffff; font-size: 17pt; font-weight: 900; letter-spacing: -0.2px;");
		addRule("#CommandHeroText", "color: " + textBody + "; font-size: 9.75pt; line-height: 140%;");
