...
namespace SparkleLauncher
{
	...
	void ApplyLauncherVisualStyle(QWidget& rootWidget)
	{
		...
		addRule("#BuildSelectionSummary", "color: " + textBody + "; font-size: 8.25pt; font-weight: 750; padding: 1px 0 7px 0;");
		addRule("#BuildSelectionSummary[State=\"warning\"]", "color: " + warning + ";");
		addRule("#BuildSelectionPanel", "background: #171a18; border: 1px solid " + divider + "; border-radius: 3px;");
		addRule("#BuildScopeRow", "background: transparent; border: none; border-bottom: 1px solid " + divider + ";");
		addRule("#BuildScopeRow:hover", "background: #1d211d;");
		addRule("#BuildScopeRow[Selected=\"true\"]", "background: #20261d;");
		addRule("#BuildScopeCheckBox", "color: " + textPrimary + "; font-size: 8.75pt; font-weight: 800;");
		addRule("#BuildScopeDescription", "color: " + textSecondary + "; font-size: 7.8pt;");
		addRule("#BuildScopeMetadata", "color: " + textMuted + "; font-size: 7.6pt; font-weight: 700; padding-left: 18px;");
		addRule("#BuildAutomationNote", "background: #1d211d; border: 1px solid " + divider + "; border-radius: 3px; margin-top: 7px;");
		addRule("#BuildAutomationTitle", "color: " + accent + "; font-size: 7.2pt; font-weight: 900; letter-spacing: 0.35px;");
		addRule("#BuildAutomationDetail", "color: " + textSecondary + "; font-size: 7.8pt;");
