...
namespace SparkleLauncher
{
	...
	QVector<LauncherWorkflowDefinition> CreateLauncherWorkflowCatalog()
	{
		return {
		    ...
		    {"Test", "Quality gates", {"project.run.smoke", "project.run.rhi-raytracing-parity", "project.run.rhi-raytracing-ptlas-benchmark", "project.run.rhi-raytracing-ptlas-article", "quality.format"}, "test"},
