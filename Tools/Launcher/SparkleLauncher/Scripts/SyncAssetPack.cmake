...
if(NOT _extract_is_project_owned OR _extract_root STREQUAL _project_root)
    message(FATAL_ERROR "Asset pack extraction must remain below the selected project root: ${_extract_root}")
endif()
...
if(NOT _extract_real_is_project_owned OR _extract_root_real STREQUAL _project_root_real)
    message(FATAL_ERROR "Asset pack extraction resolves outside the selected project root: ${_extract_root_real}")
endif()
