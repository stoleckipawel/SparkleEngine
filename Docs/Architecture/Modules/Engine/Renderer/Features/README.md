...
| `Private/Passes/Lighting`, `Private/Lighting` | [Lighting](Lighting/README.md) and its Direct, Indirect, Volumetric, and Reference Path Tracer children | surface-lighting modes, lobe targets, reservoirs, visibility, reference accumulation, composite, sky, and explicit non-surface gaps |
