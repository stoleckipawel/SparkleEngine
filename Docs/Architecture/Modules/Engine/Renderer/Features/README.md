...
| `Private/Passes/Lighting`, `Private/Lighting` | [Lighting](Lighting/README.md) and its Direct, Indirect, Volumetric, and Reference Path Tracer children | ordinary lighting lobe targets, reservoirs, visibility, composite and sky; Reference Path Tracer transport/accumulation are deliberately absent after the Stage 1 clean break; explicit non-surface gaps remain documented |
