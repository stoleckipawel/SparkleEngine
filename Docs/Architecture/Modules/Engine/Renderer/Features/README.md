...
| [Lighting](Lighting/README.md) | shared lighting composition routes direct, indirect, volumetric, and Reference Path Tracer capabilities |
...
| `REN-PBR-*`, shared `REN-LGT-*` | [Lighting](Lighting/README.md) | runs the ordinary ReSTIR surface-lighting route and joins five direct/indirect lobes, emissive, and sky into scene color; the Reference Path Tracer remains a separate per-view contract until its specialized route exists |
| direct portions of `REN-PBR-*` and `REN-LGT-*` | [Direct Lighting](Lighting/DirectLighting/README.md) | current analytic-light reservoir plus researched many-light, visibility, reconstruction, and correctness target |
| indirect portions of `REN-PBR-*` and `REN-LGT-*` | [Indirect Lighting and ReSTIR GI](Lighting/IndirectLighting/README.md) | current seed-replay prototype plus target path-resampling transport and history |
| `FCR-REN-08`, `PTD-*`, eventual `RPT-*` | [Reference Path Tracer](Lighting/ReferencePathTracer/README.md) | feature definition, discovery gate, and eventual proof contract for an independent reference oracle |
| `REN-VOL-*` | [Volumetric Lighting](Lighting/VolumetricLighting/README.md) | explicit negative capability plus blocked post-release target for media, fog, Volumetric ReSTIR, physical atmosphere/sky, and aerial perspective |
...
| `REN-DBG-*` | [Debug Views](DebugViews/README.md) | one per-view mode selects Lit, Wireframe, Reference, or produced GBuffer/lighting/scene data; display-domain correction has a separate presentation owner inside the dossier |
...
| `Private/Passes/GBuffer` | [Geometry, Materials, and GBuffer](GeometryAndResources/GeometryMaterialsAndGBuffer.md), [Debug Views](DebugViews/README.md), [Deferred Decals](DeferredDecals/README.md) | shared GBuffer composition/targets plus focused `Raster` and `RayTracing` primary- visibility frontends, depth, sky motion, and explicit absence of decal composition |
| `Private/Passes/Lighting`, `Private/Lighting` | [Lighting](Lighting/README.md) and its Direct, Indirect, Volumetric, and Reference Path Tracer children | ordinary lighting lobe targets, direct and indirect ReSTIR, reconstruction, visibility, composite and sky; the enclosed Reference Path Tracer owns its independent transport/accumulation middle; explicit non-surface gaps remain documented |
| `Private/RayTracing` | [Ray Tracing](RayTracing/README.md), [Geometry/Materials/GBuffer](GeometryAndResources/GeometryMaterialsAndGBuffer.md), [Direct Lighting](Lighting/DirectLighting/README.md), [Indirect Lighting](Lighting/IndirectLighting/README.md) | BLAS/TLAS/PTLAS, SBT, capability reporting, effect frontends/settings, and diagnostics routed by semantic consumer |
| `Private/Passes/PostProcessing/Exposure`, `Private/Passes/Presentation/{Upscaling,Display}`, `Private/Upscaling`, `Private/RayReconstruction`, `Private/Providers`, `Private/Streamline`, `Private/Integrations` | [Post Processing](PostProcessing/README.md) and its children, [Resolution/Sampling/AA](PostProcessing/ReconstructionAndGeneration/ResolutionSamplingAndAntiAliasing.md), [Temporal Sampling](FrameExecution/TemporalSamplingAndHistory.md), and [Latency Coordination](FrameExecution/LatencyCoordination.md) | exposure, render/output extent, reconstruction/upscale, sampling, tone/output, provider readiness/fallback, provider temporal constants, external runtime interop/latency, and negative AA/post features |
| `Private/Passes/Visualization`, `Private/Debug` | [Debug Views](DebugViews/README.md), [Feature Selector Catalog](RuntimeConfiguration/FeatureSelectorCatalog.md) | focused GBuffer, lighting, and GPU-scene visualization production; `Private/Debug` owns renderer diagnostic CVars and is not the visualization implementation home |
...
| Reference Path Tracer | Defined, blocked | Execute the adjacent [Discovery gate](Lighting/ReferencePathTracer/Discovery.md) through Stage 0 of the [conditional plan](Lighting/ReferencePathTracer/Plan.md); no production implementation or oracle claim is authorized yet. |
...
- Split by responsibility, not file size. Lighting separates Direct, Indirect, Volumetric, and Reference Path Tracer work. Post Processing separates Exposure, Reconstruction/Upscaling, Tone Mapping, Color Grading, Chromatic Aberration, Frame Generation, and Presentation/Output because their results, ordering, capability states, inputs, algorithms, and evidence differ.
