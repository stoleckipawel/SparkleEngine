...
- UI composition happens after graph execution and is owned by [UI and Viewport Composition](../UiAndViewportComposition.md), not by the color-conversion passes.
