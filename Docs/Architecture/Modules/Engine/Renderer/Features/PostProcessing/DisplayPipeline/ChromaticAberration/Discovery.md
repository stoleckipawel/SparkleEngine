...
At `ca55e7d8`, the then-current post-processing and presentation composition applied debug replacement before directly tone mapping, output encoding, and publishing the final product. The current owners are [`PostProcessingPasses.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/PostProcessing/PostProcessingPasses.cpp), [`PresentationPasses.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/Presentation/PresentationPasses.cpp), [`ToneMapping.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/Presentation/ToneMapping.cpp), and [`OutputEncoding.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/Presentation/OutputEncoding.cpp). [`ViewportDisplaySettings.h`](../../../../../../../../../Engine/Renderer/Private/View/ViewportDisplaySettings.h) has no lens state. No chromatic shader, pass, selector, history, or editor control was found.
