...
| --- | --- | --- |
| post/display ordering | [`PostProcessingPasses.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/PostProcessing/PostProcessingPasses.cpp) reaches debug then presentation; [`PresentationPasses.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/Presentation/PresentationPasses.cpp) publishes products built by the singular tone-mapping and output-encoding passes | a candidate edge exists, but HDR/SDR domains and exact debug/UI/capture policy are not defined by absence |
