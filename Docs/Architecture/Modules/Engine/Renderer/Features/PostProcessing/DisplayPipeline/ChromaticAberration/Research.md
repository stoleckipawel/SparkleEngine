...
| --- | --- | --- |
| post/display ordering | [`SceneRenderingPasses.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/Scene/SceneRenderingPasses.cpp) reaches presentation; [`PresentationPasses.cpp`](../../../../../../../../../Engine/Renderer/Private/Passes/Presentation/PresentationPasses.cpp) publishes products built by the singular tone-mapping and output-encoding passes | a candidate edge exists, but HDR/SDR domains and exact debug/UI/capture policy are not defined by absence |
