...
- Debug visualization may replace render-resolution scene color after exposure measurement and before the common upscale/tone/output path, but [Debug Views](../DebugViews/README.md) owns visualization semantics. Debug modes do not activate Lit ray-reconstruction denoising.
