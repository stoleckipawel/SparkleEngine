...
Verified: 2026-09-06 against committed `master` revision `baa0adc9`; public facade, external runtime, Streamline, D3D12 frame, RHI hook, and build membership inspected
...
- This contract is independent from [Frame Generation](PostProcessing/FrameGeneration.md), which remains absent.
