...
| Surface-lighting mode | ReSTIRPathTraced; ReferencePathTracer | Both produce Direct and Indirect surface-lighting lobes and require ray traversal. ReSTIR owns temporal/spatial reuse; reference owns path samples and accumulation. There is no non-ray deferred-lighting branch. |
