...
- [Pipeline and Shader Contracts](PipelineAndShaderContracts.md) and [Renderer Geometry, Materials, and GBuffer](../../Renderer/Features/GeometryMaterialsAndGBuffer.md)
