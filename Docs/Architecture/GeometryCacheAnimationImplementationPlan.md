...
- In the pre-shader-migration source layout, [`GBufferVS.hlsl`](../../Engine/Assets/Shaders/Passes/Deferred/GBufferVS.hlsl) currently evaluates morphing and skinning in the raster vertex shader. [`RayTracingMaterialHit.hlsli`](../../Engine/Assets/Shaders/RayTracing/RayTracingMaterialHit.hlsli) repeats their attribute reconstruction at ray hits. Phase 1 of the [shader-authoring implementation plan](Shaders/ShaderAuthoringAndCookedPrograms.md#phase-1---establish-virtual-sources-semantic-navigation-and-one-as-binding) moves the raster source to semantic GBuffer ownership and updates this link.
