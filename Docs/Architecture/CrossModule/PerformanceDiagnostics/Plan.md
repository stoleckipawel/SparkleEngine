...
- [Performance Diagnostics Architecture](README.md) owns metric meaning, identity, validity, data flow, product behavior, collection modes, bounded records, and rejected designs.
- [Performance Diagnostics Capability Inventory](Capability.md) owns the dated source snapshot and reconciliation gaps; refresh it before treating an implementation assumption as current.
- [Performance Diagnostics — Acceptance](Acceptance.md) owns feature-local workload evidence requirements, baseline experiments, reviewer artifacts, and verification gates.
- [Performance Diagnostics Visual Design And Tool Wireframes](VisualDesign.md) owns layouts, interaction details, responsive states, and the multi-provider viewport icon group.
- [Diagnostics Product And UX Research](ProductAndUxResearch.md) owns external precedent, option analysis, and the reasons for the selected product depth.
...
- [Bistro And San Miguel Acceptance Workloads](../../../Acceptance/GraphicsWorkloads.md) owns `MAP-00`, benchmark routes, evidence layout, sample policy, and acceptance claims.
- [Engineering guidance](../../../Engineering/README.md#choose-by-task) is binding. Select the applicable foundation, module, and verification documents through that map and follow [Change Integration](../../../Engineering/Workflow/ChangeIntegration.md) and [Change Lifecycle](../../../Engineering/Workflow/ChangeLifecycle.md) for every owned change.
...
Every package inherits [Change Integration](../../../Engineering/Workflow/ChangeIntegration.md), [Change Lifecycle](../../../Engineering/Workflow/ChangeLifecycle.md), and applicable Engineering guidance. This plan does not copy their general design, SOLID, public-surface, formatting, or evidence rules.
...
The binding [Intent-First Instrumentation And Shipping Erasure](README.md#intent-first-instrumentation-and-shipping-erasure) architecture applies to every package. Its operational rule is simple:
...
| How do production/content code stay intent-first and optional diagnostics disappear from Shipping? | [Zero Authoring Tax And Shipping Erasure Gate](#zero-authoring-tax-and-shipping-erasure-gate) and [Intent-First Instrumentation And Shipping Erasure](README.md#intent-first-instrumentation-and-shipping-erasure) |
| What does a metric mean and who owns it? | [Measurement Vocabulary](README.md#measurement-vocabulary), [Owners](README.md#owners), and [Publication Rules](README.md#publication-rules) |
| What is the bounded data/cost model? | [Collection Modes And Cost Budget](README.md#collection-modes-and-cost-budget), [Bounded Data Model](README.md#bounded-data-model), and [Demand, Cost, And Composition](README.md#demand-cost-and-composition) |
| Which stat groups are candidates and what does Tier A/B/C mean? | [Fixed Group Catalog](README.md#fixed-group-catalog) and [Delivery Tiers](README.md#delivery-tiers) |
| How should the viewport, workspace, capture, and failure states look? | [Performance Diagnostics Visual Design And Tool Wireframes](VisualDesign.md) |
| Why this product depth and not a general profiler? | [Selected Direction And Canonical Handoff](ProductAndUxResearch.md#selected-direction-and-canonical-handoff) and [Low-Clutter Integration Principles](ProductAndUxResearch.md#low-clutter-integration-principles) |
| How do internal GPU capture records work? | [On-Demand GPU Visualizer](README.md#on-demand-gpu-visualizer) |
| How do viewport provider icons and requests work? | [Attached External Frame Capture](README.md#attached-external-frame-capture) and [Attached Profiler Capture Icons](VisualDesign.md#attached-profiler-capture-icons) |
