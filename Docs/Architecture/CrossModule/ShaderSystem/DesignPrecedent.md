...
**Authority boundary:** [Shader System Architecture](README.md) owns the selected local design; the [delivery plan](Plan.md) owns sequencing; code and executable build configuration own implemented behavior
