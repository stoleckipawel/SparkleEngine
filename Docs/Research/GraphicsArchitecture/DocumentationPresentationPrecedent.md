...
The binding Sparkle form of these findings is [Documentation Organization](../../Engineering/Workflow/DocumentationOrganization.md#reader-first-page-contract). New or substantially revised pages use the [Documentation Page Template](../../Engineering/Workflow/DocumentationPageTemplate.md). The first applied routes are [SparkleEngine At A Glance](../../Architecture/EngineAtAGlance.md), [Renderer](../../Architecture/Modules/Engine/Renderer/README.md), and [RHI](../../Architecture/Modules/Engine/RHI/README.md).
