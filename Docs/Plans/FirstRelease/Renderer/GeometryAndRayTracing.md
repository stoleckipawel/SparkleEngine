...
**Architecture:** [Geometry And Resources](../../../Architecture/Modules/Engine/Renderer/Features/GeometryAndResources/README.md), [Renderer Ray Tracing](../../../Architecture/Modules/Engine/Renderer/Features/RayTracing/README.md), and [RHI Ray Tracing](../../../Architecture/Modules/Engine/RHI/Features/PipelineAndExecution/RayTracing.md)
...
**Goal:** close `FCR-REN-23` by implementing the authored decal path, bounded scene/GPU representation, deterministic post-GBuffer composition, and equivalent secondary-ray material resolution defined by the [deferred-decals contract](../../../Architecture/Modules/Engine/Renderer/Features/DeferredDecals/Acceptance.md).
