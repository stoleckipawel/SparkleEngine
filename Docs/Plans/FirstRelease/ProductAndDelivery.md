...
**Architecture owners:** [Projects/Showcase](../../Architecture/Modules/Projects/Showcase/README.md), [Application](../../Architecture/Modules/Engine/Application/README.md), [Editor](../../Architecture/Modules/Engine/Editor/README.md), [Launcher](../../Architecture/Modules/Tools/Launcher/README.md), and [Build And Packaging](../../Architecture/Modules/BuildAndPackaging/README.md)
...
```text
 ...
 M Docs/Plans/CapabilityEvidence.md
 M Docs/Plans/README.md
 M Docs/Plans/Renderer/README.md
 M Docs/README.md
...
| --- | --- | --- |
| `FCR-PROD-01` | [Showcase runtime consumer `AC/FM/CHK`](../../Architecture/Modules/Projects/Showcase/README.md#fcr-prod-01-runtime-consumer-contract), with [Application host boundary](../../Architecture/Modules/Engine/Application/README.md#product-contract-boundary) | `Blocked`; no package/consumer UI, console erasure, state, or journey evidence. |
| `FCR-PROD-02` | [Build/Packaging source adopter `AC/FM/CHK`](../../Architecture/Modules/BuildAndPackaging/README.md#fcr-prod-02-source-adopter-contract) | `Blocked`; no clean cold/warm result and optional Launcher membership is not separated. |
| `FCR-PROD-03` | [Launcher `AC/FM/CHK`](../../Architecture/Modules/Tools/Launcher/README.md#fcr-prod-03-launcher-contract) | `Blocked`; no non-author failure/cancel/clean/handoff result. |
| `FCR-PROD-04` | [Editor `AC/FM/CHK`](../../Architecture/Modules/Engine/Editor/README.md#fcr-prod-04-editor-contract), with [Application host boundary](../../Architecture/Modules/Engine/Application/README.md#product-contract-boundary) | `Blocked`; Developer-only source path exists, but build/journey/package-erasure proof is absent. |
| `FCR-PROD-05` | [Packaging `AC/FM/CHK`](../../Architecture/Modules/BuildAndPackaging/PackagingAndInstallation.md#fcr-prod-05-package-contract) | `Blocked`; implementation owner/product absent. |
| `FCR-PROD-06` | [Support/incident `AC/FM/CHK`](../../Architecture/Modules/BuildAndPackaging/AdoptionSupportAndIncidentResponse.md#fcr-prod-06-support-and-incident-contract) | `Blocked`; public files/channels/export/operating owner/patch route absent. |

The cross-module [persona journey freeze](../../Architecture/CrossModule/ProductExecutionTraces.md#pd-0-persona-journey-freeze) owns the horizontal entry-to-failure/exit trace; it does not duplicate these local criteria.
