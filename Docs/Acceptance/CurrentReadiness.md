...
| `FCR-REN-08` | offline/reference path-traced lighting | **20** | `15/5/0/0` | Early source route; oracle claim blocked | accepted transport scope, estimator, deterministic raw result, independence, parity, and full proof |
