...
**Snapshot:** 2026-09-13 against committed revision `ae5bf882fe83b110ed07541a10e3435ded2c650c` plus the current uncommitted Reference Path Tracer Stage-4 working tree; no release-approved candidate report was found
...
| `FCR-REN-08` | Reference Path Tracer | **35** | `30/5/0/0` | Stage 4 **IMPLEMENTED / VALIDATION DEFERRED**: the host-agnostic alternate recipe has the included ordinary-binary32 reflective estimator in source over canonical camera, Philox, and shared PBR BSDF/light/visibility/MIS/roulette owners; the current candidate is not compiled/cooked or GPU-exercised, Stage 5 content/robust endpoints remain open, and user-facing state remains unavailable | carry forward current-source compile/cook, raw GPU analytic/statistical/fault evidence, independent precision review, complete content/robust endpoints, session identity, deterministic accumulation, live UX/transitions, parity, packaging, and full oracle evidence; grant no acceptance credit until executed |
