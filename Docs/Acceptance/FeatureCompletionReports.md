...
| `FCR-REN-24` | [Color Grading](../Architecture/Modules/Engine/Renderer/Features/PostProcessing/DisplayPipeline/ColorGrading.md) defines an admitted scene-referred control and single-LUT stage before tone mapping; no implementation was found. | Neutral and analytic controls, LUT asset/domain/interpolation, view/reset, stage/color-domain truth, debug/capture, failure, backend, package, quality, and cost. | `PGE-01`, `PGE-02`, `PGE-05`, `PGE-08`, `PGE-09`, `PGE-13` |
| `FCR-REN-25` | [Chromatic Aberration](../Architecture/Modules/Engine/Renderer/Features/PostProcessing/DisplayPipeline/ChromaticAberration.md) defines an admitted bounded output-space radial channel-separation pass; no implementation was found. | Zero identity, normalized controls, resolution scaling, edge/alpha behavior, stage/debug/UI order, view isolation, failure, backend, package, quality, and cost. | `PGE-01`, `PGE-02`, `PGE-05`, `PGE-08`, `PGE-09`, `PGE-13` |
| `FCR-REN-26` | [HDR Display Output](../Architecture/Modules/Engine/Renderer/Features/PostProcessing/DisplayPipeline/HDRDisplayOutput.md) defines an admitted Windows HDR10 output transform and RHI presentation route with mandatory SDR fallback; no implementation was found. | PQ/Rec.2020/peak/UI policy, format/color-space/metadata tuple, requested/active/fallback truth, transitions/recovery, paired backends, HDR hardware, capture, package, quality, and cost. | `PGE-01`, `PGE-02`, `PGE-05`, `PGE-06`, `PGE-08`, `PGE-09`, `PGE-13`, `PGE-15` |
