...
#include "/Engine/Passes/PostProcessing/Exposure/ExposureReduceCommon.hlsli"
...
void main(uint3 groupId : SV_GroupID, uint3 groupThreadId : SV_GroupThreadID)
{
	...
	const float2 moments =
	    pixel.x < width && pixel.y < height ? Exposure::BuildLogLuminanceMoment(SceneColor.Load(int3(pixel, 0)).rgb) : 0.0f.xx;
