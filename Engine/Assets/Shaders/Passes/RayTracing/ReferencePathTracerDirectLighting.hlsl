...
void AccumulateReferencePathTracerDirectLight(GBufferData surface,
...
void EvaluateReferencePathTracerDirectLighting(GBufferData surface,
                                               float3 positionWorld,
                                               float3 viewDirWorld,
                                               uint sampleIndex,
                                               out float3 diffuse,
                                               ...
                                               out float3 subsurface)
{
	...
	{
		AccumulateReferencePathTracerDirectLight(
		    surface,
		    positionWorld,
		    viewDirWorld,
...
void main(uint3 id : SV_DispatchThreadID)
{
	...
	for (uint sampleIndex = 0u; sampleIndex < sampleCount; ++sampleIndex)
	{
		...
		EvaluateReferencePathTracerDirectLighting(
		    g,
		    positionWorld,
		    viewDirWorld,
		    sampleIndex,
