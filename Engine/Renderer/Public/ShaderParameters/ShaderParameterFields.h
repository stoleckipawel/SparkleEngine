...
public:
	...
	void Reset() noexcept { m_handle = FrameGraphAccelerationStructureHandle::Invalid(); }
...
SPARKLE_RENDERER_API bool BindParameterField(PassParameterSet& parameterSet, const char* name, const ShaderSamplerSet& field);
