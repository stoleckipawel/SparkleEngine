...
template <typename T>
struct ShaderParameterSemanticTraits;

template <>
struct ShaderParameterSemanticTraits<ReadTexture>
{
...
template <>
struct ShaderParameterSemanticTraits<ReadBuffer>
{
...
template <>
struct ShaderParameterSemanticTraits<RWTexture>
{
...
template <>
struct ShaderParameterSemanticTraits<RWBuffer>
{
...
template <>
struct ShaderParameterSemanticTraits<RenderTarget>
{
...
template <>
struct ShaderParameterSemanticTraits<DepthTarget>
{
...
template <>
struct ShaderParameterSemanticTraits<SamplerSet>
{
...
template <typename T>
struct ShaderParameterSemanticTraits<UniformData<T>>
{
	using ValueType = T;
...
template <typename T>
struct IsShaderParameterSemantic : std::false_type
{};

template <>
struct IsShaderParameterSemantic<ReadTexture> : std::true_type
{};

template <>
struct IsShaderParameterSemantic<ReadBuffer> : std::true_type
{};

template <>
struct IsShaderParameterSemantic<RWTexture> : std::true_type
{};

template <>
struct IsShaderParameterSemantic<RWBuffer> : std::true_type
{};

template <>
struct IsShaderParameterSemantic<RenderTarget> : std::true_type
{};

template <>
struct IsShaderParameterSemantic<DepthTarget> : std::true_type
{};

template <>
struct IsShaderParameterSemantic<SamplerSet> : std::true_type
{};

template <typename T>
struct IsShaderParameterSemantic<UniformData<T>> : std::true_type
{};

template <typename T>
constexpr bool IsShaderParameterSemanticV = IsShaderParameterSemantic<T>::value;