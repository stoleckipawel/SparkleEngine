...
ConsoleVariable<float> CVarExposureMin(
    "r.Exposure.Min",
    0.000001f,
    "Minimum linear exposure multiplier after metering and compensation.");

ConsoleVariable<float> CVarExposureMax(
    "r.Exposure.Max",
    65536.0f,
    "Maximum linear exposure multiplier after metering and compensation.");
