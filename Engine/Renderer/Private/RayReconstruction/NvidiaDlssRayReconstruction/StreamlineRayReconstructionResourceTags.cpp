    ...
    const RayReconstructionEvaluationDesc& evaluation) noexcept
{
	...
	StreamlineTaggedTextureResource noisyColor(evaluation.BackendApi, evaluation.NativeNoisyInputColorView);
	StreamlineTaggedTextureResource outputColor(evaluation.BackendApi, evaluation.NativeOutputColorView);
	...
	StreamlineTaggedTextureResource normals(evaluation.BackendApi, evaluation.NativeNormalsView);
	StreamlineTaggedTextureResource roughness(evaluation.BackendApi, evaluation.NativeRoughnessView);
	StreamlineTaggedTextureResource diffuseAlbedo(evaluation.BackendApi, evaluation.NativeDiffuseAlbedoView);
	StreamlineTaggedTextureResource specularAlbedo(evaluation.BackendApi, evaluation.NativeSpecularAlbedoView);
	StreamlineTaggedTextureResource specularHitDistance(evaluation.BackendApi, evaluation.NativeSpecularHitDistanceView);
