...
#include "Renderer/Private/RayTracing/Effects/ReferencePathTracer/ReferencePathTracerUniformData.h"

class ReferencePathTracerIndirectLightingCS final : public GlobalShader<ReferencePathTracerIndirectLightingCS>
{
public:
