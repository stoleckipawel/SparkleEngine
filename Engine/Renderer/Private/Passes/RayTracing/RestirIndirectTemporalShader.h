...
public:
	...
	SHADER_PARAMETER_TEXTURE_UAV(RWTexture2D, TemporalReservoirWeightTexture)
	SHADER_PARAMETER_TEXTURE_SRV(Texture2D, PreviousReservoirSampleTexture)
	SHADER_PARAMETER_TEXTURE_SRV(Texture2D, PreviousReservoirWeightTexture)
	SHADER_PARAMETER_TEXTURE_SRV(Texture2D, PreviousReservoirSurfaceTexture)
