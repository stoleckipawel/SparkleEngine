    ...
    bool createRayReconstructionGuides)
{
	...
	lighting.DirectSubsurface =
	    LightingRenderTargetFactory::CreateLightingTexture(builder, "DirectSubsurface", sceneExtent, radianceFormat);
	...
	lighting.IndirectSpecular =
	    LightingRenderTargetFactory::CreateLightingTexture(builder, "IndirectSpecular", sceneExtent, radianceFormat);
	const RenderViewportExtent guideExtent = createRayReconstructionGuides ? sceneExtent : RenderViewportExtent{1u, 1u};
	lighting.ReconstructionGuides.DiffuseAlbedo = LightingRenderTargetFactory::CreateLightingTexture(
	    builder,
	    "RayReconstructionDiffuseAlbedo",
	    guideExtent,
	    PixelFormat::R16G16B16A16_Float);
	lighting.ReconstructionGuides.SpecularAlbedo = LightingRenderTargetFactory::CreateLightingTexture(
	    builder,
	...
	lighting.ReconstructionGuides.SpecularHitDistance = LightingRenderTargetFactory::CreateLightingTexture(
	    builder,
