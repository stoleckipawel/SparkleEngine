...
public:
	...
	{
		return {VanDerCorput(kHaltonBaseX, index) - kNormalizedOffsetRange, VanDerCorput(kHaltonBaseY, index) - kNormalizedOffsetRange};
	}
...
DirectX::XMFLOAT2 TemporalJitterPatterns::GenerateJitterOffset(float width, float height, uint32_t frameIndex, Pattern pattern) noexcept
{
