...
public:
	...
	SHADER_PARAMETER_TEXTURE_SRV_NAMED(Texture2D, TemporalReservoirSample, TemporalReservoirSampleTexture)
	SHADER_PARAMETER_TEXTURE_SRV_NAMED(Texture2D, TemporalReservoirWeight, TemporalReservoirWeightTexture)
	SHADER_PARAMETER_TEXTURE_UAV_NAMED(RWTexture2D, CurrentReservoirSample, CurrentReservoirSampleTexture)
	SHADER_PARAMETER_TEXTURE_UAV_NAMED(RWTexture2D, CurrentReservoirWeight, CurrentReservoirWeightTexture)
	SHADER_PARAMETER_TEXTURE_UAV_NAMED(RWTexture2D, CurrentReservoirSurface, CurrentReservoirSurfaceTexture)
