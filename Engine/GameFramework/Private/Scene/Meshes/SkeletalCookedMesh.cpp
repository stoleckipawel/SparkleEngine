...
SkeletalCookedMesh::SkeletalCookedMesh(SkeletalCookedMesh&&) noexcept = default;

SkeletalCookedMesh& SkeletalCookedMesh::operator=(SkeletalCookedMesh&&) noexcept = default;
