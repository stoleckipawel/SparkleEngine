...
class SPARKLE_ENGINE_API ImmutableRenderMeshHandle final
{
  public:
	...
	ImmutableRenderMeshHandle(
	    ...
	    m_assetId(assetId), m_resource(std::move(resource))
	{
	}
	bool IsValid() const noexcept
	{
		return m_assetId != Assets::InvalidCookedAssetId && m_resource != nullptr;
	}
	...
	{
		return m_assetId == other.m_assetId && m_resource == other.m_resource;
	}
