...
namespace SparkleUiTheme
{
	...
	void ConfigureTypography(float dpiScale)
	{
		...
		g_bodyFont = LoadFirstAvailableFont(
		    {"C:/Windows/Fonts/segoeui.ttf", "C:/Windows/Fonts/Inter-Regular.ttf", nullptr, nullptr},
		    bodySize);
		...
		g_monoFont = LoadFirstAvailableFont(
		    {"C:/Windows/Fonts/JetBrainsMono-Regular.ttf", "C:/Windows/Fonts/JetBrainsMonoNL-Regular.ttf", "C:/Windows/Fonts/consola.ttf", nullptr},
		    monoSize);
