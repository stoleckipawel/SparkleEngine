...
namespace VulkanVertexLayout
{
	...
	inline constexpr std::array<VkVertexInputAttributeDescription, 4> kStaticMeshAttributes{
	    ...
	    VkVertexInputAttributeDescription{.location = 2, .binding = 0, .format = VK_FORMAT_R32G32B32_SFLOAT, .offset = 36},
	    VkVertexInputAttributeDescription{.location = 3, .binding = 0, .format = VK_FORMAT_R32G32B32A32_SFLOAT, .offset = 48}};
