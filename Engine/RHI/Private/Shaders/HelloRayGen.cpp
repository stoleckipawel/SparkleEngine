...
IMPLEMENT_RAY_TRACING_SHADER(
    HelloRayGen,
    "HelloWorld/RayTracing/HelloRayGen.hlsl",
    "HelloRayGen");

IMPLEMENT_RAY_TRACING_SHADER(
    HelloMiss,
    "HelloWorld/RayTracing/HelloMiss.hlsl",
    "HelloMiss");

IMPLEMENT_RAY_TRACING_SHADER(
    HelloClosestHit,
    "HelloWorld/RayTracing/HelloClosestHit.hlsl",
    "HelloClosestHit");

IMPLEMENT_RAY_TRACING_SHADER(
    HelloAnyHit,
    "HelloWorld/RayTracing/HelloAnyHit.hlsl",
    "HelloAnyHit");

IMPLEMENT_RAY_TRACING_SHADER(
    HelloIntersection,
    "HelloWorld/RayTracing/HelloIntersection.hlsl",
    "HelloIntersection");

IMPLEMENT_RAY_TRACING_SHADER(
    HelloCallable,
    "HelloWorld/RayTracing/HelloCallable.hlsl",
    "HelloCallable");
